...
from Diplom_project.Pages.settings import BASE_URL
from Diplom_project.Pages.search_page import SearchPage
from Diplom_project.Pages.movie_page import MoviePage
